...
import (
	...
	"github.com/ride-app/catalog-service/api/ride/catalog/v1alpha1/catalogv1alpha1connect"
...
func main() {
	...
	mux.Handle(
		catalogv1alpha1connect.NewCatalogServiceHandler(service, connectInterceptors),
	)
