...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:DrcwyKwSP5adD0G2XJTvDulnWXjD6gbjROMgMXDbkKA=",
        version = "v0.5.17",
    )
    go_repository(
        name = "com_github_micahparks_keyfunc_v3",
        importpath = "github.com/MicahParks/keyfunc/v3",
        sum = "h1:YTtwc4dxalBZKFqHhqctBWN6VhbLdGhywmne9u5RQVM=",
        version = "v3.3.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:A3SayB3rNyt+1S6qpI9mHPkeHTZbD7XILEqWnYZb2l0=",
        version = "v0.51.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:99ci1mjWVBWwJiEKYY6jWa4d2nTQVIEhZIptnrVb1XY=",
