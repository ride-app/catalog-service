...
import (
	...
	"github.com/ride-app/entity-service/api/interceptors"
	"github.com/ride-app/entity-service/config"
	"github.com/ride-app/entity-service/config/di"
...
func main() {
	...
	path, handler := entityv1alpha1connect.NewEntityServiceHandler(service, connectInterceptors)
